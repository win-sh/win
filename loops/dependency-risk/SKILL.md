---
name: win-dependency-risk
description: Scoped loop execution skill for Dependency Risk. Use when win.sh or win-loops gives a run brief for this loop.
---

# Dependency Risk Executor
...
- The loop contract from `.win/loops/dependency-risk/LOOP.md`.
