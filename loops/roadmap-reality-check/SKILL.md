---
name: win-roadmap-reality-check
description: Scoped loop execution skill for Roadmap Reality Check. Use when win.sh or win-loops gives a run brief for this loop.
---

# Roadmap Reality Check Executor
...
- The loop contract from `.win/loops/roadmap-reality-check/LOOP.md`.
