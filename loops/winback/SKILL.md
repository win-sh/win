---
name: win-winback
description: Scoped loop execution skill for Winback Loop. Use when win.sh or win-loops gives a run brief for this loop.
---

# Winback Loop Executor
...
- The loop contract from `.win/loops/winback/LOOP.md`.
