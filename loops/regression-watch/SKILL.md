---
name: win-regression-watch
description: Scoped loop execution skill for Regression Watch. Use when win.sh or win-loops gives a run brief for this loop.
---

# Regression Watch Executor
...
- The loop contract from `.win/loops/regression-watch/LOOP.md`.
