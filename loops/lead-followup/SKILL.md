---
name: win-lead-followup
description: Scoped loop execution skill for Lead Follow-up. Use when win.sh or win-loops gives a run brief for this loop.
---

# Lead Follow-up Executor
...
- The loop contract from `.win/loops/lead-followup/LOOP.md`.
