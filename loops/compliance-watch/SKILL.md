---
name: win-compliance-watch
description: Scoped loop execution skill for Compliance Watch. Use when win.sh or win-loops gives a run brief for this loop.
---

# Compliance Watch Executor
...
- The loop contract from `.win/loops/compliance-watch/LOOP.md`.
