---
name: win-failed-payment-recovery
description: Scoped loop execution skill for Failed Payment Recovery. Use when win.sh or win-loops gives a run brief for this loop.
---

# Failed Payment Recovery Executor
...
- The loop contract from `.win/loops/failed-payment-recovery/LOOP.md`.
