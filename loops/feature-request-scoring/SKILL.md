---
name: win-feature-request-scoring
description: Scoped loop execution skill for Feature Request Scoring. Use when win.sh or win-loops gives a run brief for this loop.
---

# Feature Request Scoring Executor
...
- The loop contract from `.win/loops/feature-request-scoring/LOOP.md`.
