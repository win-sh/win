---
name: win-mrr-anomaly
description: Scoped loop execution skill for MRR Anomaly. Use when win.sh or win-loops gives a run brief for this loop.
---

# MRR Anomaly Executor
...
- The loop contract from `.win/loops/mrr-anomaly/LOOP.md`.
