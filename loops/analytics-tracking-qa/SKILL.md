---
name: win-analytics-tracking-qa
description: Scoped loop execution skill for Analytics Tracking QA. Use when win.sh or win-loops gives a run brief for this loop.
---

# Analytics Tracking QA Executor
...
- The loop contract from `.win/loops/analytics-tracking-qa/LOOP.md`.
