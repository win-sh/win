---
name: win-activation-optimizer
description: Scoped loop execution skill for Activation Optimizer. Use when win.sh or win-loops gives a run brief for this loop.
---

# Activation Optimizer Executor
...
- The loop contract from `.win/loops/activation-optimizer/LOOP.md`.
