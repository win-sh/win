---
name: win-weekly-business-review
description: Scoped loop execution skill for Weekly Business Review. Use when win.sh or win-loops gives a run brief for this loop.
---

# Weekly Business Review Executor
...
- The loop contract from `.win/loops/weekly-business-review/LOOP.md`.
