---
name: win-docs-support-gap
description: Scoped loop execution skill for Docs Support Gap. Use when win.sh or win-loops gives a run brief for this loop.
---

# Docs Support Gap Executor
...
- The loop contract from `.win/loops/docs-support-gap/LOOP.md`.
