---
name: win-failed-job-recovery
description: Scoped loop execution skill for Failed Job Recovery. Use when win.sh or win-loops gives a run brief for this loop.
---

# Failed Job Recovery Executor
...
- The loop contract from `.win/loops/failed-job-recovery/LOOP.md`.
