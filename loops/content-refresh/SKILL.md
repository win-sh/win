---
name: win-content-refresh
description: Scoped loop execution skill for Content Refresh. Use when win.sh or win-loops gives a run brief for this loop.
---
...
- The loop contract from `.win/loops/content-refresh/LOOP.md`.
