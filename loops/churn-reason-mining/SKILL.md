---
name: win-churn-reason-mining
description: Scoped loop execution skill for Churn Reason Mining. Use when win.sh or win-loops gives a run brief for this loop.
---

# Churn Reason Mining Executor
...
- The loop contract from `.win/loops/churn-reason-mining/LOOP.md`.
