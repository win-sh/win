...
description: Scoped loop execution skill for Bug Autofix. Use when win.sh or win-loops gives a run brief for this loop.
---
...
- The loop contract from `.win/loops/bug-autofix/LOOP.md`.
