---
name: win-gsc-rank-growth
description: Scoped loop execution skill for GSC Rank Growth. Use when win.sh or win-loops gives a run brief for this loop.
---

# GSC Rank Growth Executor
...
- The loop contract from `.win/loops/gsc-rank-growth/LOOP.md`.
