---
name: win-email-outreach
description: Scoped loop execution skill for Email Outreach. Use when win.sh or win-loops gives a run brief for this loop.
---

# Email Outreach Executor
...
- The loop contract from `.win/loops/email-outreach/LOOP.md`.
