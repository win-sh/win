---
name: win-quality-regression
description: Scoped loop execution skill for Quality Regression. Use when win.sh or win-loops gives a run brief for this loop.
---

# Quality Regression Executor
...
- The loop contract from `.win/loops/quality-regression/LOOP.md`.
