---
name: win-lifecycle-nurture
description: Scoped loop execution skill for Lifecycle Nurture. Use when win.sh or win-loops gives a run brief for this loop.
---

# Lifecycle Nurture Executor
...
- The loop contract from `.win/loops/lifecycle-nurture/LOOP.md`.
