---
name: win-landing-page-match
description: Scoped loop execution skill for Landing Page Match. Use when win.sh or win-loops gives a run brief for this loop.
---

# Landing Page Match Executor
...
- The loop contract from `.win/loops/landing-page-match/LOOP.md`.
