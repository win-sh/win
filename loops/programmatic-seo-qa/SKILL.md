---
name: win-programmatic-seo-qa
description: Scoped loop execution skill for Programmatic SEO QA. Use when win.sh or win-loops gives a run brief for this loop.
---

# Programmatic SEO QA Executor
...
- The loop contract from `.win/loops/programmatic-seo-qa/LOOP.md`.
