---
name: win-backup-restore-drill
description: Scoped loop execution skill for Backup Restore Drill. Use when win.sh or win-loops gives a run brief for this loop.
---

# Backup Restore Drill Executor
...
- The loop contract from `.win/loops/backup-restore-drill/LOOP.md`.
