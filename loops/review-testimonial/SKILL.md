---
name: win-review-testimonial
description: Scoped loop execution skill for Review Testimonial Loop. Use when win.sh or win-loops gives a run brief for this loop.
---

# Review Testimonial Loop Executor
...
- The loop contract from `.win/loops/review-testimonial/LOOP.md`.
