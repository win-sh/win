---
name: win-pricing-experiment
description: Scoped loop execution skill for Pricing Experiment. Use when win.sh or win-loops gives a run brief for this loop.
---

# Pricing Experiment Executor
...
- The loop contract from `.win/loops/pricing-experiment/LOOP.md`.
