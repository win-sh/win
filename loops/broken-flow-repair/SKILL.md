---
name: win-broken-flow-repair
description: Scoped loop execution skill for Broken Flow Repair. Use when win.sh or win-loops gives a run brief for this loop.
---

# Broken Flow Repair Executor
...
- The loop contract from `.win/loops/broken-flow-repair/LOOP.md`.
