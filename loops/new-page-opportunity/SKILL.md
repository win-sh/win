---
name: win-new-page-opportunity
description: Scoped loop execution skill for New Page Opportunity. Use when win.sh or win-loops gives a run brief for this loop.
---

# New Page Opportunity Executor
...
- The loop contract from `.win/loops/new-page-opportunity/LOOP.md`.
