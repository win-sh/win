---
name: win-seo-growth
description: Scoped loop execution skill for SEO Growth. Use when win.sh or win-loops gives a run brief for this loop.
---
...
- The loop contract from `.win/loops/seo-growth/LOOP.md`.
