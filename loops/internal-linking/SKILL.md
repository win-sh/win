---
name: win-internal-linking
description: Scoped loop execution skill for Internal Linking. Use when win.sh or win-loops gives a run brief for this loop.
---
...
- The loop contract from `.win/loops/internal-linking/LOOP.md`.
