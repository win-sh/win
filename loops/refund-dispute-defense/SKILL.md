---
name: win-refund-dispute-defense
description: Scoped loop execution skill for Refund and Dispute Defense. Use when win.sh or win-loops gives a run brief for this loop.
---

# Refund and Dispute Defense Executor
...
- The loop contract from `.win/loops/refund-dispute-defense/LOOP.md`.
