---
name: win-crm-hygiene
description: Scoped loop execution skill for CRM Hygiene. Use when win.sh or win-loops gives a run brief for this loop.
---

# CRM Hygiene Executor
...
- The loop contract from `.win/loops/crm-hygiene/LOOP.md`.
