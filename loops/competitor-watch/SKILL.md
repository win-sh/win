---
name: win-competitor-watch
description: Scoped loop execution skill for Competitor Watch. Use when win.sh or win-loops gives a run brief for this loop.
---

# Competitor Watch Executor
...
- The loop contract from `.win/loops/competitor-watch/LOOP.md`.
