---
name: win-knowledge-hygiene
description: Scoped loop execution skill for Knowledge Hygiene. Use when win.sh or win-loops gives a run brief for this loop.
---

# Knowledge Hygiene Executor
...
- The loop contract from `.win/loops/knowledge-hygiene/LOOP.md`.
