---
name: win-email-deliverability
description: Scoped loop execution skill for Email Deliverability. Use when win.sh or win-loops gives a run brief for this loop.
---

# Email Deliverability Executor
...
- The loop contract from `.win/loops/email-deliverability/LOOP.md`.
