---
name: win-technical-seo
description: Scoped loop execution skill for Technical SEO. Use when win.sh or win-loops gives a run brief for this loop.
---
...
- The loop contract from `.win/loops/technical-seo/LOOP.md`.
