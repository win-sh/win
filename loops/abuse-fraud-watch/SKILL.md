---
name: win-abuse-fraud-watch
description: Scoped loop execution skill for Abuse and Fraud Watch. Use when win.sh or win-loops gives a run brief for this loop.
---

# Abuse and Fraud Watch Executor
...
- The loop contract from `.win/loops/abuse-fraud-watch/LOOP.md`.
