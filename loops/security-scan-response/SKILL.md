---
name: win-security-scan-response
description: Scoped loop execution skill for Security Scan Response. Use when win.sh or win-loops gives a run brief for this loop.
---

# Security Scan Response Executor
...
- The loop contract from `.win/loops/security-scan-response/LOOP.md`.
