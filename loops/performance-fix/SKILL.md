---
name: win-performance-fix
description: Scoped loop execution skill for Performance Fix. Use when win.sh or win-loops gives a run brief for this loop.
---
...
- The loop contract from `.win/loops/performance-fix/LOOP.md`.
