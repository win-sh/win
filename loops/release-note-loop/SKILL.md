---
name: win-release-note-loop
description: Scoped loop execution skill for Release Note Loop. Use when win.sh or win-loops gives a run brief for this loop.
---

# Release Note Loop Executor
...
- The loop contract from `.win/loops/release-note-loop/LOOP.md`.
