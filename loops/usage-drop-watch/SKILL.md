---
name: win-usage-drop-watch
description: Scoped loop execution skill for Usage Drop Watch. Use when win.sh or win-loops gives a run brief for this loop.
---

# Usage Drop Watch Executor
...
- The loop contract from `.win/loops/usage-drop-watch/LOOP.md`.
