---
name: win-integration-health
description: Scoped loop execution skill for Integration Health. Use when win.sh or win-loops gives a run brief for this loop.
---

# Integration Health Executor
...
- The loop contract from `.win/loops/integration-health/LOOP.md`.
