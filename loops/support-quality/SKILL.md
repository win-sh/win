---
name: win-support-quality
description: Scoped loop execution skill for Support Quality. Use when win.sh or win-loops gives a run brief for this loop.
---

# Support Quality Executor
...
- The loop contract from `.win/loops/support-quality/LOOP.md`.
