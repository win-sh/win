---
name: win-creative-testing
description: Scoped loop execution skill for Creative Testing. Use when win.sh or win-loops gives a run brief for this loop.
---

# Creative Testing Executor
...
- The loop contract from `.win/loops/creative-testing/LOOP.md`.
