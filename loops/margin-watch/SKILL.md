---
name: win-margin-watch
description: Scoped loop execution skill for Margin Watch. Use when win.sh or win-loops gives a run brief for this loop.
---

# Margin Watch Executor
...
- The loop contract from `.win/loops/margin-watch/LOOP.md`.
